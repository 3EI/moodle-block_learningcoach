 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class learner_register implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $enrolmenturl = new \moodle_url('/blocks/learningcoach/enrolment.php',  array('cid' => $COURSE->id, 'ct' => $context->id));
        $data = array(
